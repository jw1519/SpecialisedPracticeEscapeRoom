...
public class OptitrackHmd : MonoBehaviour
{
    ...
    bool DevicePresent()
    {
        ...
        return UnityEngine.XR.XRSettings.enabled && isPresent();
#else
...
#if UNITY_2017_2_OR_NEWER
        string deviceFamily = XRSettings.loadedDeviceName;
        string deviceModel = InputDevices.GetDeviceAtXRNode(XRNode.Head).name;
#else
